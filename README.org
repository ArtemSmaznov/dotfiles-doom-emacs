...
(use-package! org-tree-slide
  ...
  (map! :map org-mode-map
        :leader
        :desc "Presentation" "t p" #'org-tree-slide-mode
        )
  :bind
...
(use-package! org-caldav
  ...
  (setq
   ...
   org-caldav-save-directory "~/documents/org/.caldav/"
...
(use-package! spell-fu
  ...
  (setq ispell-dictionary "english"
        ispell-personal-dictionary (expand-file-name "dict/.pwd" (xdg-data-home))))
#+end_src
