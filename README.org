...
(if IS-MAC (setq
 doom-unicode-font        (font-spec :family "DejaVuSansM Nerd Font Mono" :size 22)))
...
(use-package! org-caldav
  ...
  (setq
   org-caldav-url (password-store-get-field "tools/org-caldav" "url")
...
(use-package! elfeed-protocol
  ...
  (defvar elfeed-protocol-orig-feeds nil
    "Store original content of `elfeed-protocol-feeds'.")
